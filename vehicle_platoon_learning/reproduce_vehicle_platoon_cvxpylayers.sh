...
run_case 3vehicle_cvxpylayer \
  --benchmark 3vehicle --methods cvxpylayer --solver SCS
run_case 5vehicle_cvxpylayer \
  --benchmark 5vehicle \
  --xml vehicle_platoon_learning/data/5_vehicle_official/5_vehicle_platoon.xml \
  --methods cvxpylayer --solver SCS
run_case 10vehicle_cvxpylayer \
  --benchmark 10vehicle \
